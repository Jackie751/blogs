        ...
        <div style={{padding:'20px 20px 14px',borderBottom:'1px solid rgba(255,255,255,0.06)',position:'sticky',top:0,zIndex:20,background:'#060608'}}>
          <div style={{display:'flex',alignItems:'flex-end',justifyContent:'space-between',marginBottom:14}}>
            <div>
              ...
              <div style={{fontFamily:'monospace',fontSize:11,color:'rgba(255,255,255,0.35)',letterSpacing:'.15em',marginTop:4}}>PERSONAL SPACE</div>
            </div>
    ...
    <div style={{display:'flex',flexDirection:'column',height:'100vh',background:'#060608',color:'#e8ddd0',fontFamily:"'Noto Sans SC',sans-serif"}}>
      ...
      <div style={{flex:1,position:'relative',overflow:'hidden',display:'flex',alignItems:'center',justifyContent:'center'}}>
        ...
        <button onClick={()=>move(-1)} disabled={visible.length<=1}
          style={{position:'absolute',left:20,top:'50%',transform:'translateY(-50%)',zIndex:30,background:'none',border:'none',color:'rgba(255,255,255,0.25)',fontSize:32,cursor:'pointer',padding:'8px',transition:'color .2s',opacity:visible.length<=1?0:1}}
          onMouseEnter={e=>e.currentTarget.style.color='#fff'}
        ...
        <button onClick={()=>move(1)} disabled={visible.length<=1}
          style={{position:'absolute',right:20,top:'50%',transform:'translateY(-50%)',zIndex:30,background:'none',border:'none',color:'rgba(255,255,255,0.25)',fontSize:32,cursor:'pointer',padding:'8px',transition:'color .2s',opacity:visible.length<=1?0:1}}
          onMouseEnter={e=>e.currentTarget.style.color='#fff'}
          onMouseLeave={e=>e.currentTarget.style.color='rgba(255,255,255,0.25)'}>›</button>
      </div>
